...
BEGIN_MESSAGE_MAP(CTestMFCDlg, CDialog)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
   ON_BN_CLICKED(IDC_TESTGRAPH, OnBnClickedTestgraph)
   ON_BN_CLICKED(IDC_TESTCHART, OnBnClickedTestchart)
END_MESSAGE_MAP()
...
void CTestMFCDlg::OnBnClickedTestgraph()
{
   m_GraphPage.DoModal();
}

void CTestMFCDlg::OnBnClickedTestchart()
{
   m_ChartPage.DoModal();
}
