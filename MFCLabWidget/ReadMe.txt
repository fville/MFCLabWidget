========================================================================
    STATIC LIBRARY : MFCLabWidget Project Overview
========================================================================

AppWizard has created this MFCLabWidget library project for you. 
This file contains a summary of what you will find in each of the files that
make up your MFCLabWidget application.
...
StdAfx.h, StdAfx.cpp
    ...
    named MFCLabWidget.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "MFCLabWidget.rc" and a "MFCLabWidget.h" that 
